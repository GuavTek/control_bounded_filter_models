...
class HardCB:
	...
	def WriteVerilogIIRCoefficients(self, fileName, exponent):
		f = open(fileName + '.sv', 'w')
		f.write("`ifndef " + fileName + "_SV_\n`define " + fileName + "_SV_\r\n")
		f.write("package " + fileName + ";\r\n")
	...
	def WriteVerilogFIRCoefficients(self, fileName, OSR):
		...
		f.write("package " + fileName + ";\r\n")
		f.write("\tlocalparam N = " + str(self.N) + ";\n")
		f.write("\tlocalparam OSR = " + str(OSR) + ";\n")
